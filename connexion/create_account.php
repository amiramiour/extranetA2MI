...
function sendEmailToClient($email, $nom, $prenom, $password) {
    ...
    //$body = 'Bonjour ' . $prenom . ',<br><br>Votre compte a été créé avec succès. Voici vos informations de connexion :<br><br>Nom d\'utilisateur : ' . $email . '<br>Mot de passe : ' . $password . '<br><br>Vous pouvez vous connecter à votre compte en utilisant le lien suivant : <a href="http://localhost/extranetA2MI/connexion/connexion.php">Se connecter</a><br><br>Merci de votre confiance.<br>L\'équipe de notre site.';
    $body = "Bonjour, \n\n";
