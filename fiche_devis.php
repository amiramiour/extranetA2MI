...
<div id="app" class="app app-header-fixed app-sidebar-fixed app-content-full-height">
    ...
    <div id="content" class="app-content">
        ...
        <!-- END breadcrumb -->
        <!-- BEGIN page-header -->
        <h1 class="page-header hidden-print">Fiche <small>Devis</small></h1>
        <!-- END page-header -->
        <!-- BEGIN invoice -->
        <div class="invoice">
            <!-- BEGIN invoice-company -->
            <div class="invoice-company">
                Devis n° <?=$commande['cmd_devis_id'];?>
                <span class="float-end hidden-print">
                    <a href="#" id="export-pdf" data-devis-id="<?= $commande['cmd_devis_id'] ?>" class="btn btn-sm btn-white mb-10px"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Exporter</a>
            ...
            <div class="invoice-header">
                <div class="invoice-from">
                    <address class="mt-5px mb-5px">
                        <strong class="text-white">Commentaire</strong><br />
                        <?= $commande['commentaire']?><br />
                </div>
                <div class="invoice-to">
                    <address class="mt-5px mb-5px">
                        <strong class="text-white">Fichiers images</strong><br />
                ...
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <tr>
                            ...
                            <th class="text-center" width="10%">Qte demandée</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?=$produit['quantite_demandee']?></td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        exportPdfBtn.addEventListener('click', function(event) {
            ...
            const devisId = this.getAttribute('data-devis-id');
            const url = `extraire_devis.php?id=${devisId}`;
