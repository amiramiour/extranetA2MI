    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed app-content-full-height">
        ...
        <div id="content" class="app-content">
            ...
            <ol class="breadcrumb float-xl-end">
                ...
                <li class="breadcrumb-item active">Sites web</li>
            </ol>
            <!-- END breadcrumb -->
            <!-- BEGIN page-header -->
            <h1 class="page-header">Tableaux des informations de la page Sites<small></small></h1>
            <!-- END page-header -->
            <!-- BEGIN row -->
            <div class="row">
                <!-- BEGIN col-12 -->
                        ...
                        <div class="panel-body">
                            <table id="data-table-combine" class="table table-striped table-bordered align-middle">
                                ...
                                <tr>
                                    ...
                                    <th class="text-nowrap w-300px">Titre</th>
                                    <th class="text-nowrap w-20px">Lien</th>
                                    <th width="1%"></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php foreach ($sitewebs as $siteweb) : ?>
                                    <tr>
                                        <td><?= $siteweb->site_img_id ?></td>
                                        <td>
                                            <?php if ($siteweb->site_img_active >= 1) : ?>
                                        ...
                                        <td>
                                            <?php if (!empty($siteweb->site_img_photo)) : ?>
                                                <img src="img/Sites/<?= $siteweb->site_img_photo ?>" class="rounded
                                                h-40px" />
                                            <?php else : ?>
                                                <img src="img/placeholder.jpg" class="rounded h-30px" />
                                            <?php endif; ?>
                                        </td>
                                        <td><?= $siteweb->site_img_title ?></td>
                                        <td>
                                            <a href="<?= $siteweb->site_img_link ?>" target="_blank" class="btn btn-sm btn-info w-40px me-1">
                                                <i class="fas fa-lg fa-fw me-10px fa-right-from-bracket"></i>
                                            </a>
                                        </td>
                                        <td nowrap>
