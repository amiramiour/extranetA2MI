...
try {
    ...
    $query = "SELECT pret_caution, pret_dateout, commentaire FROM pret WHERE pret_id = :id";
        ...
        <div class="container mt-3">
            ...
            <form action="traitement_modification_pret.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="date_rendu" name="date_rendu" value="<?php echo date('Y-m-d', strtotime($pret['pret_dateout'])); ?>">
                </div>
                <div class="form-group">
