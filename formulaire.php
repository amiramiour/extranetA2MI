                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" data-parsley-validate="true" name="demo-form">
                                <div class="form-group row mb-3">
                                    <label class="col-lg-4 col-form-label form-label" for="fullname">Full Name *
                                        :</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group row mb-3">
                                    <label class="col-lg-4 col-form-label form-label" for="message">Message (20 chars
                                        min, 200 max) :</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-select" id="select-required" name="selectBox"
                                                data-parsley-required="true">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-8 pt-2">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" name="radiorequired"
                                                   value="foo" id="radioRequired1" data-parsley-required="true"/>
                                            <label class="form-check-label" for="radioRequired1">Radio Button 1</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" class="form-check-input" name="radiorequired"
                                                   id="radioRequired2" value="bar"/>
                                            <label class="form-check-label" for="radioRequired2">Radio Button 2</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="radio" class="form-check-input" name="radiorequired"
                                                   id="radioRequired3" value="key"/>
                                            <label class="form-check-label" for="radioRequired3">Radio Button 2</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label class="col-lg-4 col-form-label form-label">Check at least 2 checkboxes
                                        :</label>
                                    <div class="col-lg-8 pt-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="mincheck1"
                                                   name="mincheck[]" data-parsley-mincheck="2" value="foo" required/>
                                            <label class="form-check-label" for="mincheck1">Checkbox 1</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="checkbox" class="form-check-input" id="mincheck2"
                                                   name="mincheck[]" value="bar"/>
                                            <label class="form-check-label" for="mincheck2">Checkbox 2</label>
                                        </div>
                                        <div class="form-check mt-2">
                                            <input type="checkbox" class="form-check-input" id="mincheck3"
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <small class="fs-12px text-gray-500-darker">We'll never share your email with
                                            anyone else.</small>
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
