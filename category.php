...
if (isset($_SESSION['role']) AND $_SESSION['role'] == 'admin' AND isset($_SESSION['mail'])):
    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed app-content-full-height">
        ...
        <div id="content" class="app-content">
            ...
            <!-- END breadcrumb -->
            <!-- BEGIN page-header -->
            <h1 class="page-header">Liste des Catégories <small></small></h1>
            <!-- END page-header -->
            <!-- BEGIN row -->
            <div class="row">
                <!-- BEGIN col-12 -->
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <table id="data-table-combine" class="table table-striped table-bordered align-middle">
                                <thead>
                                <tr>
                                    <th width="1%" class="text-nowrap">N° Catégorie</th>
                                ...
                                <?php foreach ($allcategories as $category) : ?>
                                    <tr class="odd gradeX">
                                        <td><?= $category->shop_categorie_id ?></td>
                                        <td><?= $category->shop_categorie_nom ?></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
