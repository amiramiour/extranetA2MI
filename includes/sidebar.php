            ...
            <div class="menu">
                ...
                <div class="menu-item <?php if($result=="fournisseurs") echo 'active'; ?>">
                    ...
                    <div class="menu-item <?php if($result=="bi") echo 'active'; ?>">
                        <a href="../list_bi.php" class="menu-link">
                            <div class="menu-icon">
                                <i class="fa fa-users"></i>
                            </div>
                    ...
                    <div class="menu-item <?php if($result=="commandes_devis") echo 'active'; ?>">
                        <a href="commandes_devis.php" class="menu-link">
                            <div class="menu-icon">
                                <i class="fa fa-users"></i>
                            </div>
                            <div class="menu-text">Commandes / Devis</div>
                        </a>
                    </div>
                    <div class="menu-item <?php if($result=="pret") echo 'active'; ?>">
                        <a href="../list_pret.php" class="menu-link">
                            <div class="menu-icon">
                                <i class="fa fa-users"></i>
                            </div>
