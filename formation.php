...
if (isset($_SESSION['role']) AND $_SESSION['role'] == 'admin' AND isset($_SESSION['mail'])): ?>
    ...
    <div id="app" class="app app-header-fixed app-sidebar-fixed app-content-full-height">
        ...
        <div id="content" class="app-content">
            ...
            <!-- END breadcrumb -->
            <!-- BEGIN page-header -->
            <h1 class="page-header">Tableaux des Formations <small></small></h1>
            <!-- END page-header -->
            <!-- BEGIN row -->
            <div class="row">
                <!-- BEGIN col-12 -->
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <table id="data-table-combine" class="table table-striped table-bordered align-middle">
                                <thead>
                                <tr>
                                    <th width="1%" class="text-nowrap">N° Formation</th>
                                    <th class="text-nowrap w-20px">Active</th>
                                    <th class="text-nowrap w-100px">Titre</th>
                                    <th class="text-nowrap w-400px">Description</th>
                                    <th class="text-nowrap w-100px">Fichier</th>
                                ...
                                <?php foreach ($allformations as $formation) : ?>
                                    <tr class="odd gradeX">
                                        <td><?= $formation->site_img_id ?></td>
                                        <td>
                                            <?php if ($formation->site_img_active >= 1) : ?>
                                                <i class="fas fa-lg fa-fw me-10px text-green fa-check"></i>
                                            <?php else : ?>
                                                <i class="fas fa-lg fa-fw me-10px text-red fa-xmark"></i>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= $formation->site_img_title ?></td>
                                        <td><?= $formation->site_img_description ?></td>
                                        <td><?= $formation->site_img_link ?></td>
                                        <td nowrap>
                                            <a href="#" class="btn btn-sm btn-warning w-40px me-1"><i class="fas fa-lg fa-fw me-10px fa-pen-to-square"></i></a>
                                            <a href="img/formation/<?= $formation->site_img_link ?>"
                                               target="_blank"
                                               class="btn btn-sm btn-info w-40px me-1"><i class="fas fa-lg fa-fw me-10px fa-download"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
